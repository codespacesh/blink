...
export async function generateMetadata(props: {
  ...
  return { title: `Logs · ${ag.name} · ${org.name} - Blink` };
}
...
export default async function LogsPage({
  ...
  // Check permission - logs require write or admin access
  ...
  // Parse search query from query params
  let initialSearchQuery = undefined;
