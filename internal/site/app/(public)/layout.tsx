...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <Head>
        {/* Preload LayGrotesk fonts for faster loading */}
        <link
          rel="preload"
          href="/fonts/LayGrotesk-Regular.woff2"
          as="font"
          type="font/woff2"
        ...
        <link
          rel="preload"
          href="/fonts/LayGrotesk-Medium.woff2"
          as="font"
          type="font/woff2"
          crossOrigin="anonymous"
        />
      ...
      <ThemeProvider forcedTheme="dark" attribute="class">
        <div
          className={`public-layout bg-neutral-900 min-h-screen flex flex-col font-laygrotesk ${geist.variable}`}
        >
