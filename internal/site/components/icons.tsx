  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.5 3.5C4.5 1.567 6.067 0 8 0C9.933 0 11.5 1.567 11.5 3.5C11.5 4.328 11.172 5.078 10.634 5.634C11.172 6.19 11.5 6.94 11.5 7.768C11.5 8.596 11.172 9.346 10.634 9.902C11.172 10.458 11.5 11.208 11.5 12.036C11.5 13.969 9.933 15.536 8 15.536C6.067 15.536 4.5 13.969 4.5 12.036C4.5 11.208 4.828 10.458 5.366 9.902C4.828 9.346 4.5 8.596 4.5 7.768C4.5 6.94 4.828 6.19 5.366 5.634C4.828 5.078 4.5 4.328 4.5 3.5ZM8 1.5C6.895 1.5 6 2.395 6 3.5C6 4.605 6.895 5.5 8 5.5C9.105 5.5 10 4.605 10 3.5C10 2.395 9.105 1.5 8 1.5ZM6 7.768C6 6.663 6.895 5.768 8 5.768C9.105 5.768 10 6.663 10 7.768C10 8.873 9.105 9.768 8 9.768C6.895 9.768 6 8.873 6 7.768ZM8 10.036C6.895 10.036 6 10.931 6 12.036C6 13.141 6.895 14.036 8 14.036C9.105 14.036 10 13.141 10 12.036C10 10.931 9.105 10.036 8 10.036Z"
        fill="currentColor"
      />
    </svg>
  );
...
const LogoClaude = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      viewBox="0 0 24 24"
...
const LogoGrok = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
const CrossSmallIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
...
const LogoApple = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    xmlSpace="preserve"
...
export const LogoBlink = ({
  ...
  <svg
    height={size}
    viewBox={hideText ? "108 0 30 32" : "0 0 138 32"}
    fill="currentColor"
    xmlns="http://www.w3.org/2000/svg"
    className={className}
  >
...
const GitPullRequestIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const LogoMoonshot = ({ size = 16 }: { size?: number }) => (
  <svg
    fill="currentColor"
    fillRule="evenodd"
    height={size}
...
export const LogoBlinkHopping = ({
  ...
  const playOnce = useCallback(() => {
    ...
    // Animation lasts 3500ms, so stop after that
  ...
  const stopGracefully = useCallback(() => {
    ...
    if (elapsed < 1450) {
      ...
      timeoutRef.current = setTimeout(stop, 3500 - elapsed);
    }
  }, [playing, stop]);
  ...
  return (
    ...
    >
      <Image
        src={playing ? "/blink-hop.png" : "/blink-hop-static.png"}
        alt="Blink Hopping"
        width={size * 2}
        height={size * 2}
...
const LogoBlinkFlashing = ({
  ...
  const stopGracefully = useCallback(() => {
    ...
    // If we're close to the end of the cycle (within 25ms), stop immediately
    if (elapsed >= 850) {
      stop();
      return;
    }

    // Otherwise wait for the end of this cycle
    timeoutRef.current = setTimeout(stop, 875 - elapsed);
  }, [playing, stop]);
  ...
  return (
    <div
      ...
      onClick={() => {
        if (playing) return; // Ignore clicks during animation
        playContinuous();
      }}
    >
      <Image
        src={playing ? "/blink-flash.png" : "/blink-flash-static.png"}
        alt="Blink Flashing"
        width={size * 3}
        height={size * 3}
        style={{
...
const LinearIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="#222326"
    width={size}
...
const AsanaIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
